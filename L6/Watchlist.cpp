...
//the genre field is found between the first and second blank "space" characters - the following method searches for the specific blank characters and compares the string found between them with the given one
{
	fstream aux;
	aux.open("Genre.txt");
